  ...
  return (
    <Fragment>
     <Paper className={`${FeatureStyles.feature} dark_feature`} elevation={10}>
      <Stack direction="row"  style={{justifyContent: 'space-between',alignItems: 'center'}}  height="20%" width="100%">
   ...
   <Typography className="text-center"> previous transactions processing last payments may not be included</Typography>
    <Stack direction="row" width="100%" style={{justifyContent: "space-around", alignItems: 'center'}}>
    <Stack style={{alignItems: 'center'}}>
    <Typography>Target</Typography>
    <Box><IconButton><KeyboardArrowDownIcon color="error" /></IconButton>$12.4K</Box>
    </Stack>
    <Stack style={{alignItems: 'center'}}>
    <Typography>Target</Typography>
    <Box><IconButton><KeyboardArrowDownIcon color="success" /></IconButton>$12.4K</Box>
    </Stack>
    <Stack style={{alignItems: 'center'}}>
    <Typography>Target</Typography>
    <Box><IconButton><KeyboardArrowDownIcon color="error" /></IconButton>$12.4K</Box>
