...
// list of items that found in userTableData
// this list displayed in home page
function ListItems() {
  return (
    <Fragment>
      <Paper elevation={10}>
            ...
            <TableBody>
              {rows.map((row) => (
                ...
                >
                  ...
                  <TableCell
                    align="center"
                    className={`${styles.customer_item} dark_tablecell`}
                  >
                    <Avatar
                      alt={row.customer}
                      src={row.img}
                    ...
                    />
                    <Typography style={{ width: '45%', height: '50%' }}>
                      {row.customer}
                    </Typography>
                  </TableCell>
                  <TableCell align="center" className="dark_tablecell">
